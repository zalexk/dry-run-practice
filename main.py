...
if ("code" not in st.session_state) and ("ans" not in st.session_state):
    generate_question()
    
st.warning("The question and answer are generated by AI. Therefore, the content may be incorrect, and all responses should be treated as reference material only.")
st.warning("If your answer is wrong, please re-run the code through your compiler for verification.")
